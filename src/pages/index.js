...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Wajahat</title>
        <link rel="image_src" href={`${domainName}/images/profilePicture.png`}/>
        <meta
          name="description"
          content="Hey, this is my personal website. You can take a look at my resume, download my CV and see how you can contact me."
        />
        <meta property="og:title" content="Wajahat" />
        <meta property="og:site_name" content="Wajahat" />
        ...
        <meta
          property="og:image"
          content={`${domainName}/images/profilePicture.png`}
        />
        <meta property="og:image:width" content="1580"/>
        <meta property="og:image:height" content="790"/>
        <meta name="twitter:image" content={`${domainName}/images/profilePicture.png`}/>
      </Head>
      <Modal />
      <NavBar />
